...
<head>
	...
	<!--end::Page Vendors -->
	<link href="/webroot/metronic/assets/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
	<script type="text/javascript" charset="utf8" src="https://code.jquery.com/jquery-3.3.1.js"></script>
	<link href="/webroot/metronic/assets/vendors/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
	<!--end::Page Vendors -->
	<link href="/webroot/metronic/assets/vendors/base/vendors.bundle.css" rel="stylesheet" type="text/css" />
	<link href="/webroot/metronic/assets/demo/demo10/base/style.bundle.css" rel="stylesheet" type="text/css" />
	<!--end::Base Styles -->
	<link rel="shortcut icon" href="/webroot/metronic/assets/demo10/demo/media/img/logo/favicon.ico" />
	<script type="text/javascript" charset="utf8" src="https://code.jquery.com/jquery-3.3.1.js"></script>
</head>
<!-- end::Head -->
<!-- end::Body -->
							...
							<div class="m-stack m-stack--ver m-stack--general m-stack--inline">
								<div class="m-stack__item m-stack__item--middle m-brand__logo">
									<a href="index.html" class="m-brand__logo-wrapper">
										<img alt="" src="/webroot/metronic/assets/demo/demo10/media/img/logo/logo.png" class="m-brand__logo-desktop"/>
										<img alt="" src="/webroot/metronic/assets/demo/demo10/media/img/logo/logo_mini.png" class="m-brand__logo-mobile"/>
									</a>
								</div>
									...
									<li class="m-nav__item m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
										<a href="#" class="m-nav__link m-dropdown__toggle">
											<span class="m-topbar__userpic">
												<img src="/webroot/metronic/assets/app/media/img/users/user4.jpg" class="m--img-rounded m--marginless m--img-centered" alt=""/>
											</span>
												...
												<div class="m-dropdown__header m--align-center">
													<div class="m-card-user m-card-user--skin-light">
														<div class="m-card-user__pic">
															<img src="/webroot/metronic/assets/app/media/img/users/user4.jpg" class="m--img-rounded m--marginless" alt=""/>
														</div>
									...
									<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
										...
										<ul class="m-menu__subnav">
											<li class="m-menu__item "  m-menu-link-redirect="1" aria-haspopup="true">
												<a  href="/users/index" class="m-menu__link ">
											...
											<li class="m-menu__item  m-menu__item--active "  aria-haspopup="true">
												<a  href="/dashboards/generalapi" class="m-menu__link ">
						...
						<div class="m-messenger__wrapper">
							<div class="m-messenger__message m-messenger__message--in">
								<div class="m-messenger__message-pic">
									<img src="/webroot/metronic/assets/app/media/img//users/user3.jpg" alt=""/>
								</div>
...
<ul class="m-nav-sticky" style="margin-top: 30px;">
	...
	<!-- begin::Quick Nav -->
	<!--begin::Base Scripts -->
	<script src="/webroot/metronic/assets/vendors/base/vendors.bundle.js" type="text/javascript"></script>
	<script src="/webroot/metronic/assets/demo/demo10/base/scripts.bundle.js" type="text/javascript"></script>
	<!--end::Base Scripts -->
	<!--begin::Page Vendors -->
	<script src="/webroot/metronic/assets/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
	<!--end::Page Vendors -->
	<!--begin::Page Snippets -->
	<script src="/webroot/metronic/assets/app/js/dashboard.js" type="text/javascript"></script>
	<!--end::Page Snippets -->


	<!-- begin::Quick Nav -->

	<script src="/webroot/metronic/assets/demo/default/custom/crud/metronic-datatable/base/html-table.js" type="text/javascript"></script>
</body>
<!-- end::Body -->
...
<!--begin::Page Vendors -->
<script src="/webroot/metronic/assets/vendors/custom/datatables/datatables.bundle.js" type="text/javascript"></script>
<!--end::Page Vendors -->
<!--begin::Page Resources -->
<script src="/webroot/metronic/assets/demo/default/custom/crud/datatables/basic/basic.js" type="text/javascript"></script>
<!--end::Page Resources -->
