...
<link rel="stylesheet" type="text/css" href="webroot/webroot/include/rs-plugin/css/settings.css" media="screen" />
<link rel="stylesheet" type="text/css" href="webroot/webroot/include/rs-plugin/css/layers.css">
<link rel="stylesheet" type="text/css" href="webroot/webroot/include/rs-plugin/css/navigation.css">
        ...
        <header id="header" class="full-header transparent-header">
            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="index.html" class="standard-logo" data-dark-logo="webroot/webroot/images/logo-dark.png"><img src="webroot/webroot/images/logo.png" alt="Canvas Logo"></a>
                        <a href="index.html" class="retina-logo" data-dark-logo="webroot/webroot/images/logo-dark@2x.png"><img src="webroot/webroot/images/logo@2x.png" alt="Canvas Logo"></a>
                    </div><!-- #logo end -->
                                ...
                                <div class="top-cart-items">
                                    <div class="top-cart-item clearfix">
                                        <div class="top-cart-item-image">
                                            <a href="#"><img src="webroot/webroot/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
                                        </div>
                                    ...
                                    <div class="top-cart-item clearfix">
                                        <div class="top-cart-item-image">
                                            <a href="#"><img src="webroot/webroot/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
                                        </div>
                                        <div class="top-cart-item-desc">
       ...
       <!--  <section id="content" style="overflow: visible">
         <section id="slider" class="slider-element slider-parallax" style="background-color: #222;">
            <div id="oc-slider" class="owl-carousel carousel-widget" data-margin="0" data-items="1" data-pagi="false" data-loop="true" data-animate-in="rollIn" data-speed="450" data-animate-out="rollOut" data-autoplay="5000">
                ...
                <a href="#"><img src="webroot/webroot/images/slider/full/1.jpg" alt="Slider"></a>
                <a href="#"><img src="webroot/webroot/images/slider/full/2.jpg" alt="Slider"></a>
                <a href="#"><img src="webroot/webroot/images/slider/full/3.jpg" alt="Slider"></a>
                <a href="#"><img src="webroot/webroot/images/slider/full/4.jpg" alt="Slider"></a>
                <a href="#"><img src="webroot/webroot/images/slider/full/1.jpg" alt="Slider"></a>
                <a href="#"><img src="webroot/webroot/images/slider/full/2.jpg" alt="Slider"></a>
                <a href="#"><img src="webroot/webroot/images/slider/full/3.jpg" alt="Slider"></a>
                <a href="#"><img src="webroot/webroot/images/slider/full/4.jpg" alt="Slider"></a>
                    ...
                    <div class="col_two_third">
                        ...
                        <div class="col_one_third">
                            ...
                            <div class="widget clearfix">
                                ...
                                <img src="webroot/webroot/images/footer-widget-logo.png" alt="" class="footer-logo">

                                <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

                                <div style="background: url('webroot/webroot/images/world-map.png') no-repeat center center; background-size: 100%;">
                                    <address>
...
<!-- External JavaScripts
    ...
    <script src="webroot/webroot/include/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
    <script src="webroot/webroot/include/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>

    <script src="webroot/webroot/include/rs-plugin/js/extensions/revolution.extension.slideanims.min.js"></script>
    <script src="webroot/webroot/include/rs-plugin/js/extensions/revolution.extension.actions.min.js"></script>
    <script src="webroot/webroot/include/rs-plugin/js/extensions/revolution.extension.layeranimation.min.js"></script>
    <script src="webroot/webroot/include/rs-plugin/js/extensions/revolution.extension.kenburn.min.js"></script>
    <script src="webroot/webroot/include/rs-plugin/js/extensions/revolution.extension.navigation.min.js"></script>
    <script src="webroot/webroot/include/rs-plugin/js/extensions/revolution.extension.video.min.js"></script>

<script src="https://www.gstatic.com/firebasejs/5.0.4/firebase.js"></script>
<script>
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyB-BvlFt8ANybKYhgN2pqGNzm2mHLPBxPA",
    authDomain: "abcd-web.firebaseapp.com",
    databaseURL: "https://abcd-web.firebaseio.com",
    projectId: "abcd-web",
    storageBucket: "abcd-web.appspot.com",
    messagingSenderId: "195490834416"
  };
